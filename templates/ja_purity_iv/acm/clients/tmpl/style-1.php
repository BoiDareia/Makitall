	...
	<div class="container">
		<div class="row">
			<?php for ($i=0; $i < $clientCount; $i++) : ?>
				<div class="col-6 col-sm-4 col-lg-<?php echo $columns; ?> item d-flex mb-3 mb-lg-0 align-items-center justify-content-center">
					<a href="<?php echo $helper->get('data.client-link'); ?>" class="client-image opacity-<?php echo $helper->get('opacity') ;?>">
