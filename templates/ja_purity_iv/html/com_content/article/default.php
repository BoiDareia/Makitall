          ...
          <div class="col-12 col-md-3 order-2 order-md-1 mt-5 mt-md-0">
            <div class="siderbar-article">
              ...
              <div class="social-sharing">
                <h4><?php echo Text::_('TPL_SHARE_SOCIAL_LABEL'); ?></h4>
              ...
              <?php if(JHtml::_('content.prepare', '{loadposition read-next}')) :?>
                <div class="read-next">
                  <?php echo JHtml::_('content.prepare', '{loadposition read-next}'); ?>
                </div>
              <?php endif ;?>
            </div>
          </div>
